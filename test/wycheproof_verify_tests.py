...
with open("wycheproof/mldsa_65_standard_verify_test.json", "r") as wycheproof_verify_65_tests_raw:
    ...
    for test_group in tests["testGroups"]:
        ...
        for test in test_group['tests']:
            ...
            if test['result'] == 'valid':
                assert verification_result == 0, print("Test ID is: {}".format(test['tcId']))
            else:
                assert verification_result == -1, print("result: {}, Test ID: {}".format(verification_result, test['tcId']))
