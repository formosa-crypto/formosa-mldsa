...
static void chacha20_init(uint32_t x[16], const uint8_t n[8],
                          const uint8_t k[32]) {
#define LU8U32(p, i)                                                           \
  ((((uint32_t)p[i + 3]) << 24) | (((uint32_t)p[i + 2]) << 16) |               \
   (((uint32_t)p[i + 1]) << 8) | (((uint32_t)p[i]) << 0))
...
static void chacha20(uint8_t *c, uint64_t clen, const uint8_t n[8],
                     const uint8_t k[32]) {
