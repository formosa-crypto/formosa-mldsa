...
extern int JASMIN_MLDSA87_crypto_sign_signature_ctx_seed_internal(uint8_t sig[JASMIN_MLDSA87_CRYPTO_BYTES], const uint8_t* ctx_m_rand[3], size_t ctxlen_mlen_siglen[3], uint8_t sk[JASMIN_MLDSA87_CRYPTO_SECRETKEYBYTES]);
...
int JASMIN_MLDSA87_crypto_sign_signature_ctx_seed(uint8_t sig[JASMIN_MLDSA87_CRYPTO_BYTES], size_t *siglen, uint8_t* m, size_t mlen, uint8_t *ctx, size_t ctxlen, uint8_t sk[JASMIN_MLDSA87_CRYPTO_SECRETKEYBYTES], uint8_t rand[RNDBYTES])
{
  ...
  return JASMIN_MLDSA87_crypto_sign_signature_ctx_seed_internal(sig, ctx_m_rand, ctxlen_mlen_siglen, sk);
}
