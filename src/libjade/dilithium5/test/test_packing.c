...
int main ()
{
    ...
    check_sig_czh(PQCLEAN_DILITHIUM5_CLEAN_pack_sig_jazz, PQCLEAN_DILITHIUM5_CLEAN_pack_sig, "_pack_sig_jazz");
    check_czh_sig(PQCLEAN_DILITHIUM5_CLEAN_unpack_sig_jazz, PQCLEAN_DILITHIUM5_CLEAN_unpack_sig, "_unpack_sig_jazz");
    return 0;
}
