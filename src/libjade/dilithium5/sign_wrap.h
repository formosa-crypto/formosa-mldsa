...
int PQCLEAN_DILITHIUM5_CLEAN_crypto_sign_signature_internal_jazz(uint8_t sig[PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_SECRETKEYBYTES], int32_t* m,  int32_t siglen_mlen[2], uint8_t sk[PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_SECRETKEYBYTES]);
...
int PQCLEAN_DILITHIUM5_CLEAN_crypto_sign_signature_jazz(uint8_t sig[PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_SECRETKEYBYTES], int32_t *siglen, int32_t* m, int32_t mlen, uint8_t sk[PQCLEAN_DILITHIUM5_CLEAN_CRYPTO_SECRETKEYBYTES])
{
  uint32_t siglen_mlen[2];
